...
- `coursework_methodical_instructions.docx` — методические указания;
- `structure_scheme.png` — структурная схема, по которой строится интерфейс;
...
Часть формул внутри `coursework_methodical_instructions.docx` хранится как
